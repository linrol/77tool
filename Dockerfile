...
CMD git config --global user.email "backend-ci@77hub.com" && git config --global user.name "backend-ci" && service postgresql start && python3 app.py -p=8076 -i="wwcba5faed367cdeee" -s="d8x9pOUynLxggWIrxWecj9oupX59EwFH9teCkC9J1H4" -t="UNn2blWtjouEPUSeMsVS5A9eTjy5Z" -k="VpPjRfzYsddGOlSVJRVvUQeOaS6hjrAVYb3bobmWapw" >> /data/logs/branch-manage-`date +%Y%m%d`.log 2>&1