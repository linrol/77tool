...
branch_group = {}
module_mapping = {
    "all": ['mono', 'framework', 'enterprise', 'enterprise-apps', 'enterprise-apps-api', 'global-apps', 'global-apps-api'],
    "global": ['framework', 'global-apps', 'global-apps-api'],
    "apps": ['mono', 'framework', 'enterprise', 'enterprise-apps', 'enterprise-apps-api']
}
